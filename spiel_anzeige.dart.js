...
$$.main_anon = {"":"Closure;heim_anzeige_0",
 call$1: function(e) {
  var t1 = this.heim_anzeige_0;
  t1.set$text($.anzeigeMinus(t1.get$text()));
}
};

$$.main_anon0 = {"":"Closure;heim_anzeige_1",
 call$1: function(e) {
  var t1, ret;
  t1 = this.heim_anzeige_1;
  ret = $.add($.int_parse(t1.get$text()), 1);
  t1.set$text($.getInterceptor(ret).toString$0(ret));
}
};

$$.main_anon1 = {"":"Closure;ausw_anzeige_2",
 call$1: function(e) {
  var t1 = this.ausw_anzeige_2;
  t1.set$text($.anzeigeMinus(t1.get$text()));
}
};

$$.main_anon2 = {"":"Closure;ausw_anzeige_3",
 call$1: function(e) {
  var t1, ret;
  t1 = this.ausw_anzeige_3;
  ret = $.add($.int_parse(t1.get$text()), 1);
  t1.set$text($.getInterceptor(ret).toString$0(ret));
}
};
...
$.main = function() {
  var heim_anzeige, heim_minus, heim_plus, ausw_minus, ausw_plus, ausw_anzeige, t1;
  heim_anzeige = $.query("#heim_anzeige");
  heim_minus = $.query("#heim_minus");
  heim_plus = $.query("#heim_plus");
  ausw_minus = $.query("#ausw_minus");
  ausw_plus = $.query("#ausw_plus");
  ausw_anzeige = $.query("#ausw_anzeige");
  t1 = heim_minus.get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon(heim_anzeige));
  t1 = heim_plus.get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon0(heim_anzeige));
  t1 = ausw_minus.get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon1(ausw_anzeige));
  t1 = ausw_plus.get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon2(ausw_anzeige));
};

$.anzeigeMinus = function(er) {
  var ret;
  if ($.eqB($.int_parse(er), 0))
    return $.CONSTANT3.toString$0(0);
  ret = $.sub($.int_parse(er), 1);
  return $.getInterceptor(ret).toString$0(ret);
};
...
//@ sourceMappingURL=spiel_anzeige.dart.js.map